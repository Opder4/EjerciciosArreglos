...
Console.WriteLine("Los número ingresados mostrando si son pares o impares:");
Console.WriteLine();
for (int i = 0; i < numeros.Length; i++)
{
    if (numeros[i] % 2 == 0)
    {
        Console.Write($"         El número {numeros[i]} es par           ");
        Console.Write("");
    }
    else
    {
        Console.Write($"         El número {numeros[i]} es impar           ");
        Console.Write("");
    }
}
